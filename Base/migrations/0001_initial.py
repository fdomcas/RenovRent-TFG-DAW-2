# Generated by Django 5.2.14 on 2026-05-15 23:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('Casa', 'Casa'), ('Apartamento', 'Apartamento'), ('Piso', 'Piso'), ('Chalet', 'Chalet'), ('Bungalow', 'Bungalow'), ('Mansión', 'Mansión'), ('Dúplex', 'Dúplex'), ('Ático', 'Ático'), ('Adosado', 'Adosado'), ('Local', 'Local Comercial'), ('Oficina', 'Oficina'), ('Nave', 'Nave Industrial'), ('Garaje', 'Garaje'), ('Terreno', 'Terreno / Solar')], default='Piso', max_length=100)),
                ('precio', models.IntegerField(default=0)),
                ('retorno_anual_porcentaje', models.IntegerField(default=0)),
                ('num_habitaciones', models.IntegerField(blank=True, null=True)),
                ('num_banos', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('foto', models.FileField(blank=True, null=True, upload_to='fotos/perfil/')),
